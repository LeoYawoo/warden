...
C33Matrix Tempest::operator*(const C33Matrix &l, const C33Matrix &r) {
...
C33Matrix Tempest::operator/(const C33Matrix &l, float a) {
    float div = (1.0f / a);
    return l * div;
}
...
C3Vector Tempest::operator*(const C33Matrix &l, const C3Vector &r) {
